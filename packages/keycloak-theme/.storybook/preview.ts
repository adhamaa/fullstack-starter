...
const preview: Preview = {
  ...
  decorators: [
    (Story, context) => {
      ...
      const themePreset = String(context.globals.themePreset ?? DEFAULT_THEME_PRESET)
      const themeBase = String(context.globals.themeBase ?? DEFAULT_THEME_BASE)
      const themeRadius = String(context.globals.themeRadius ?? DEFAULT_THEME_RADIUS)
      const showPlaceholder = String(context.globals.showPlaceholder ?? DEFAULT_THEME_PLACEHOLDER)
