...
export const Template = ({ locale, t }: TemplateProps) => {
  ...
  return (
    <EmailLayout preview={t('executeActions.subject')} locale={locale}>
      ...
      <Text style={applyRTL(paragraph, isRTL, rtlStyle)}>{t('executeActions.clickLink')}</Text>
      ...
      <Text style={applyRTL(paragraph, isRTL, rtlStyle)}>{t('executeActions.ignoreMessage')}</Text>
    </EmailLayout>
  )
}
