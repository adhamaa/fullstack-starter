...
const { I18nProvider, useI18n } = i18nBuilder
  ...
  .withCustomTranslations({
    en: {
      welcomeMessage:
        'Welcome to Fullstack Starter - Your gateway to seamless planning and organization.',
    ...
    ar: {
      welcomeMessage: 'مرحبًا بك في Fullstack Starter - بوابتك إلى التخطيط والتنظيم السلس.',
    ...
    ca: {
      welcomeMessage:
        "Benvingut a Fullstack Starter: la vostra porta d'accés a una planificació i organització perfecta.",
    ...
    cs: {
      welcomeMessage:
        'Vítejte v Fullstack Starter – vaší bráně k bezproblémovému plánování a organizaci.',
    ...
    da: {
      welcomeMessage:
        'Velkommen til Fullstack Starter - din gateway til problemfri planlægning og organisering.',
    ...
    de: {
      welcomeMessage:
        'Willkommen bei Fullstack Starter – Ihr Zugang zu nahtloser Planung und Organisation.',
    ...
    el: {
      welcomeMessage:
        'Καλώς ήρθατε στην Fullstack Starter - Η πύλη σας για απρόσκοπτο σχεδιασμό και οργάνωση.',
    ...
    es: {
      welcomeMessage:
        'Bienvenido a Fullstack Starter: su puerta de entrada a una planificación y organización perfectas.',
    ...
    fa: {
      welcomeMessage:
        'به Fullstack Starter خوش آمدید - دروازه شما برای برنامه‌ریزی و سازماندهی بدون نقص.',
      ...
      welcomeMessage:
        'Tervetuloa Fullstack Starter:iin – porttisi saumattomaan suunnitteluun ja organisointiin.',
    ...
    fr: {
      welcomeMessage:
        'Bienvenue sur Fullstack Starter - Votre passerelle vers une planification et une organisation sans faille.',
    ...
    hu: {
      welcomeMessage:
        'Üdvözöljük az Fullstack Starter-nél – Az Ön kapuja a zökkenőmentes tervezéshez és szervezéshez.',
    ...
    it: {
      welcomeMessage:
        "Benvenuti in Fullstack Starter - Il vostro portale per una pianificazione e un'organizzazione senza interruzioni.",
    ...
    ja: {
      welcomeMessage: 'Fullstack Starter へようこそ - シームレスな計画と組織化へのゲートウェイ。',
    ...
    ka: {
      welcomeMessage:
        'მოგესალმებით Fullstack Starter-ში - თქვენი კარიბჭე უწყვეტი დაგეგმვისა და ორგანიზებისთვის.',
    ...
    lt: {
      welcomeMessage:
        'Sveiki atvykę į „Fullstack Starter“ – jūsų vartai į sklandų planavimą ir organizavimą.',
    ...
    lv: {
      welcomeMessage:
        'Laipni lūdzam Fullstack Starter — jūsu vārti uz nevainojamu plānošanu un organizēšanu.',
    ...
    nl: {
      welcomeMessage:
        'Welkom bij Fullstack Starter - Uw toegangspoort tot naadloze planning en organisatie.',
    ...
    no: {
      welcomeMessage:
        'Velkommen til Fullstack Starter - din inngangsport til sømløs planlegging og organisering.',
    ...
    pl: {
      welcomeMessage:
        'Witamy w Fullstack Starter — Twojej bramie do bezproblemowego planowania i organizacji.',
    ...
    pt: {
      welcomeMessage:
        'Bem-vindo à Fullstack Starter - Sua porta de entrada para planejamento e organização integrados.',
    ...
    'pt-BR': {
      welcomeMessage:
        'Bem-vindo à Fullstack Starter - Seu portal para planejamento e organização contínuos.',
    ...
    ru: {
      welcomeMessage:
        'Добро пожаловать в Fullstack Starter — ваш путь к эффективному планированию и организации.',
    ...
    sk: {
      welcomeMessage:
        'Vitajte v Fullstack Starter – vašej bráne k bezproblémovému plánovaniu a organizácii.',
    ...
    sv: {
      welcomeMessage:
        'Välkommen till Fullstack Starter - din inkörsport till sömlös planering och organisering.',
    ...
    th: {
      welcomeMessage: 'ยินดีต้อนรับสู่ Fullstack Starter - ประตูสู่การวางแผนและจัดระเบียบที่ราบรื่น',
    ...
    tr: {
      welcomeMessage:
        "Fullstack Starter'e hoş geldiniz - Kusursuz planlama ve organizasyona giden kapınız.",
    ...
    uk: {
      welcomeMessage:
        'Ласкаво просимо до Fullstack Starter — вашого шлюзу до безперебійного планування та організації.',
    ...
    'zh-CN': {
      welcomeMessage: '欢迎来到 Fullstack Starter - 开启无缝规划与组织的门户。',
    ...
    'zh-TW': {
      welcomeMessage: '歡迎來到 Fullstack Starter - 開啟無縫規劃與組織的門戶。',
