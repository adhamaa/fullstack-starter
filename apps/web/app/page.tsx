    ...
    <PageShell>
      <section className="rounded-3xl border border-slate-700 bg-bg-elevated p-8">
        ...
        <p className="text-ink-muted">
          ...
          broadcast rates. Start Docker infra, run migrations and seed, then browse remedies and
          rates.
        </p>
        ...
        <div className="mt-8 flex flex-wrap gap-3">
          <Link
            href="/remedies"
            className="rounded-lg bg-accent px-4 py-2.5 font-semibold text-accent-fg no-underline"
          >
            Browse Remedies
          </Link>
          <Link
            href="/formulas"
            className="rounded-lg border border-slate-700 px-4 py-2.5 font-semibold text-ink no-underline"
          >
            Browse Formulas
          </Link>
          <Link
