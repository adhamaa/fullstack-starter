  ...
  return (
    <main className="grid min-h-screen place-items-center p-8">
      <section className="max-w-2xl w-full rounded-3xl border border-slate-700 bg-bg-elevated p-8 shadow-[0_20px_80px_rgb(0_0_0/0.35)]">
        ...
        <h1 className="mt-4 mb-4 font-extrabold">
        ...
        {me && (
          <div className="my-5 grid gap-3 grid-cols-[repeat(auto-fit,minmax(180px,1fr))]">
            <div className="flex flex-col gap-1 rounded-xl bg-bg-muted p-3">
              <strong className="text-[0.7rem] uppercase tracking-wider text-ink-subtle">User ID</strong>
              <code>{me.id}</code>
            </div>
            <div className="flex flex-col gap-1 rounded-xl bg-bg-muted p-3">
              <strong className="text-[0.7rem] uppercase tracking-wider text-ink-subtle">Email</strong>
              <code>{me.email ?? "—"}</code>
            </div>
            <div className="flex flex-col gap-1 rounded-xl bg-bg-muted p-3">
              <strong className="text-[0.7rem] uppercase tracking-wider text-ink-subtle">Roles</strong>
